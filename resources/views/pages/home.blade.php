...
<main>
    ...
    <div class="container">
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            ...
            style="background-image: url('frontend/images/bedugul.jpg');">
            <div class="travel-country">INDONESIA</div>
            <div class="travel-location">DRATAN, BALI</div>
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="card-travel text-center d-flex flex-column"
            style="background-image: url('frontend/images/khalifaburj.jpg');">
        ...
        <div class="container">
            ...
            <div class="row mt-3">
                <div class="col-12 text-center">
                    ...
                    <a href="#" class="btn btn-get-started px-4">Get Started</a>
                </div>
            </div>
        </div>
    </section>
